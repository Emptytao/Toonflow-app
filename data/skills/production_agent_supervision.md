...
| 禁光影色调 / 禁配乐 | 严重 | 全篇不出现光影/色温/明暗/色调/暖冷等词，不出现配乐/音乐/乐器氛围烘托 | — |
...
1. 扫描全文是否出现光影/色温/明暗/色调/暖冷/逆光/侧光等词
2. 扫描全文是否出现配乐/音乐/旋律/乐器氛围烘托等词
3. 命中即判严重，建议删除并改回剧情、动作、空间或环境音层面的约束

不通过示例：情绪基调写“冷蓝色调下的压迫感”，或注意事项写“此处配低沉弦乐”。
